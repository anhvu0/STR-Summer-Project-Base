...
class RLTrainingPipeline:
    ...
    def run(self):
        ...
        for episode in range(self.episodes):
            ...
            controlled_vehicle_ids = set(vehicles.keys())
            ...
            try:
                for step in range(self.max_simulation_steps):
                    ...
                    active_controlled = [vid for vid in vehicle_ids if vid in controlled_vehicle_ids]
                    self._refresh_vehicle_snapshot(active_controlled)

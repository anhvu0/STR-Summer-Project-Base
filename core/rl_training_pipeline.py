...
class RLTrainingPipeline:
    ...
    def run(self):
        ...
        csv_fields = [
            ...
            *trainer_csv_fields[2:6], "episode_return_total", "avg_return_per_vehicle",
            *trainer_csv_fields[6:], "completion_rate", "avg_travel_time",
            "p50_travel_time", "p90_travel_time", "teleports",
            ...
            "route_candidate_count", "route_feasible_candidate_count", "route_actor_ownership_skips",
            "route_no_feasible_candidates", "route_choice_idx_0", "route_choice_idx_1",
            "route_choice_idx_2", "route_choice_idx_3", "route_valid_candidates_1",
            "route_valid_candidates_2", "route_valid_candidates_3", "route_valid_candidates_4",
            "route_choice_nonzero_rate", "route_mean_valid_candidates", "route_mean_logit_margin",
            "route_mean_chosen_length_norm", "route_mean_chosen_eta_norm", "route_mean_chosen_density",
            "route_mean_chosen_first_density", "route_mean_balance_reward", "route_mean_eta_delta_steps",
            "route_mean_density_relief", "route_mean_required_relief", "route_selfless_detour_rate",
            "route_bad_detour_rate", "decisions_considered", "decisions_opened",
            "decisions_finalized", "decisions_skipped", "loop_events",
            "safety_overrides", "loop_prefilter_overrides", "fragment_build_failures",
            "fallback_overrides", "pending_decision_timeouts", "deferred_lane_change_actions",
            "lane_change_observe_started", "lane_change_observe_success", "lane_change_observe_abort_no_progress",
            "lane_change_observe_abort_low_speed", "lane_change_observe_abort_commit_window", "pending_release_events_total",
            "pending_release_abort_events_total", "cooldown_replans_blocked", "pending_release_observe_abort_no_progress",
            "pending_release_observe_abort_commit_window", "pending_release_observe_abort_low_speed", "pending_release_wrong_lane_commit",
            "pending_release_route_no_progress_abort", "snapshot_cache_hits", "shortest_path_cache_hits",
            "override_ratio", "override_events_total", "override_event_loop_prefilter",
            "override_event_cooldown_fallback", "override_event_observe_abort_fallback", "override_event_route_apply_fail",
            "policy_masked_actions_removed", "decision_pending_at_episode_end", "mean_decision_latency_steps",
            "mean_reward_per_finalized_decision", "mean_route_difficulty_eta", "p50_route_difficulty_eta",
            "p90_route_difficulty_eta", "fail_teleport", "mean_network_density",
            "p95_network_density", "congestion_high_pressure_steps", "emergency_brake_events",
            "teleport_inferred_jam", "teleport_inferred_yield_or_deadlock", "lane_change_observe_resolution_rate",
            "tail_vehicles_over_p90_count", "tail_completion_gap_steps", "aggregate_actionable_skip_to_finalized_ratio",
            "social_regret_mean", "social_regret_p90", "social_best_action_chosen_rate",
            "structural_skip_ratio", "pending_resolution_success_rate", "pending_timeout_rate",
            "pending_abort_rate", "delay_fairness_gini", "p95_to_p50_travel_ratio",
            "fallback_rate_per_opened_decision", "controlled_teleport_rate", "skip_reason_forced_by_lane_commit",
            "skip_reason_forced_single_path", "reachable_lane_change_nonempty", "reachable_lane_change_excluded_any",
            "reachable_lane_change_excluded_all", "policy_candidates_with_broader_available", "policy_candidates_collapsed_to_lane_now_only",
            "coordination_pending_reservations_seeded", "coordination_pressure_candidates_seen", "coordination_pressure_candidates_rejected",
            "lane_now_congestion_candidates_seen", "lane_now_congestion_candidates_rejected", "proactive_shift2_candidates_seen",
            "proactive_brake_risk_candidates_seen", "proactive_brake_risk_candidates_rejected", "proactive_brake_risk_fallback_kept",
            "proactive_decisions_opened", "proactive_decisions_finalized", "lane_now_decisions_opened",
            "lane_now_decisions_finalized", "proactive_pending_abort_count", "proactive_pending_timeout_count",

...
class JunctionDecisionEngine:
    ...
    def prefilter_action_for_loops(
        ...
        edge_out_degree = {edge: len(self.connection_info.outgoing_edges_dict.get(edge, {})) for edge in set(recent_history) | {next_edge}}
        ...
        trap_like = (
            ...
            and recent_history[-1] == context.edge_id
        )
        dist_worsen = False

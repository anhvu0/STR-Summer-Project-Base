...
def test_q_learning(vehicles):
    ...
    scheduler = QLearningPolicy(vehicles, init_connection_info, './configurations/model/rl_model_map.h5') # Please watch for the correct rl_model.h5 file generated by train_rl.py
    run_simulation(scheduler, vehicles)
...
if __name__ == "__main__":
    ...
    vehicles = get_controlled_vehicles(route_file, init_connection_info, 20, 40, pattern=2)
